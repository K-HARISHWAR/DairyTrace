...
class CollectionBatchStageUpdateScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CollectionBatchStageUpdateScreen> createState() => _CollectionBatchStageUpdateScreenState();
}

class _CollectionBatchStageUpdateScreenState extends ConsumerState<CollectionBatchStageUpdateScreen> {
  ...
  Widget build(BuildContext context) {
    if (widget.batch.overallStatus.value == 'rejected' || widget.batch.overallStatus.value == 'spoiled') {
      return Scaffold(
        appBar: AppBar(title: const Text('Update Stage')),
        body: const Center(child: Padding(
          padding: EdgeInsets.all(32.0),
          child: Text('This batch is terminal (rejected/spoiled) and cannot progress further.', textAlign: TextAlign.center, style: TextStyle(color: Colors.red)),
        )),
      );
    }
          ...
          child: Column(
            ...
            children: [
              DropdownButtonFormField<BatchStage>(
                ...
                items: _getAllowedStages().map((s) => DropdownMenuItem(
                  value: s,
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Event Type * (e.g. standard_chill, pasteurized)'),
              ...
              ElevatedButton(
                ...
                child: _isLoading ? const CircularProgressIndicator() : const Text('Confirm Update'),
              ),
            ],
          ),
        ),
